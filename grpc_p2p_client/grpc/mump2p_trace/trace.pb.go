...
const (
	...
	TraceEvent_DUPLICATE_SHARD   TraceEvent_Type = 13
	TraceEvent_UNHELPFUL_SHARD   TraceEvent_Type = 14
	TraceEvent_UNNECESSARY_SHARD TraceEvent_Type = 15
	TraceEvent_NEW_SHARD         TraceEvent_Type = 16
)
...
type TraceEvent struct {
	Type                 *TraceEvent_Type             `protobuf:"varint,1,opt,name=type,enum=optimum.pb.TraceEvent_Type" json:"type,omitempty"`
	...
	DuplicateShard       *TraceEvent_ShardContainer   `protobuf:"bytes,17,opt,name=duplicateShard" json:"duplicateShard,omitempty"`
	UnhelpfulShard       *TraceEvent_ShardContainer   `protobuf:"bytes,18,opt,name=unhelpfulShard" json:"unhelpfulShard,omitempty"`
	UnnecessaryShard     *TraceEvent_ShardContainer   `protobuf:"bytes,19,opt,name=unnecessaryShard" json:"unnecessaryShard,omitempty"`
	NewShard             *TraceEvent_ShardContainer   `protobuf:"bytes,20,opt,name=newShard" json:"newShard,omitempty"`
...
func (m *TraceEvent) GetDuplicateShard() *TraceEvent_ShardContainer {
	if m != nil {
		return m.DuplicateShard
	}
	return nil
}

func (m *TraceEvent) GetUnhelpfulShard() *TraceEvent_ShardContainer {
	if m != nil {
		return m.UnhelpfulShard
	}
	return nil
}

func (m *TraceEvent) GetUnnecessaryShard() *TraceEvent_ShardContainer {
	if m != nil {
		return m.UnnecessaryShard
	}
	return nil
}

func (m *TraceEvent) GetNewShard() *TraceEvent_ShardContainer {
	if m != nil {
		return m.NewShard
	}
	return nil
...
type TraceEvent_ShardContainer struct {
	MessageID            []byte   `protobuf:"bytes,1,opt,name=messageID" json:"messageID,omitempty"`
	ReceivedFrom         []byte   `protobuf:"bytes,2,opt,name=receivedFrom" json:"receivedFrom,omitempty"`
	Coefficients         []byte   `protobuf:"bytes,3,opt,name=coefficients" json:"coefficients,omitempty"`
	XXX_NoUnkeyedLiteral struct{} `json:"-"`
	XXX_unrecognized     []byte   `json:"-"`
	XXX_sizecache        int32    `json:"-"`
}

func (m *TraceEvent_ShardContainer) Reset()         { *m = TraceEvent_ShardContainer{} }
func (m *TraceEvent_ShardContainer) String() string { return proto.CompactTextString(m) }
func (*TraceEvent_ShardContainer) ProtoMessage()    {}
func (*TraceEvent_ShardContainer) Descriptor() ([]byte, []int) {
	return fileDescriptor_0571941a1d628a80, []int{0, 3}
}
func (m *TraceEvent_ShardContainer) XXX_Unmarshal(b []byte) error {
	return m.Unmarshal(b)
}
func (m *TraceEvent_ShardContainer) XXX_Marshal(b []byte, deterministic bool) ([]byte, error) {
	if deterministic {
		return xxx_messageInfo_TraceEvent_ShardContainer.Marshal(b, m, deterministic)
	} else {
		b = b[:cap(b)]
		n, err := m.MarshalToSizedBuffer(b)
		if err != nil {
...
func (m *TraceEvent_ShardContainer) XXX_Merge(src proto.Message) {
	xxx_messageInfo_TraceEvent_ShardContainer.Merge(m, src)
}
func (m *TraceEvent_ShardContainer) XXX_Size() int {
	return m.Size()
}
func (m *TraceEvent_ShardContainer) XXX_DiscardUnknown() {
	xxx_messageInfo_TraceEvent_ShardContainer.DiscardUnknown(m)
}

var xxx_messageInfo_TraceEvent_ShardContainer proto.InternalMessageInfo

func (m *TraceEvent_ShardContainer) GetMessageID() []byte {
	if m != nil {
		return m.MessageID
	}
	return nil
...
func (m *TraceEvent_ShardContainer) GetReceivedFrom() []byte {
	if m != nil {
		return m.ReceivedFrom
	}
	return nil
...
func (m *TraceEvent_ShardContainer) GetCoefficients() []byte {
	if m != nil {
...
func (m *TraceEvent_RecvRPC) GetLength() uint64 {
...
func (m *TraceEvent_SendRPC) GetLength() uint64 {
	if m != nil && m.Length != nil {
		return *m.Length
	}
	return 0
...
type TraceEvent_RPCMeta struct {
	...
	Shards               []*TraceEvent_ShardMeta   `protobuf:"bytes,2,rep,name=shards" json:"shards,omitempty"`
	Subscription         []*TraceEvent_SubMeta     `protobuf:"bytes,3,rep,name=subscription" json:"subscription,omitempty"`
	Control              *TraceEvent_ControlMeta   `protobuf:"bytes,4,opt,name=control" json:"control,omitempty"`
	XXX_NoUnkeyedLiteral struct{}                  `json:"-"`
	XXX_unrecognized     []byte                    `json:"-"`
	XXX_sizecache        int32                     `json:"-"`
}
...
func (m *TraceEvent_RPCMeta) GetShards() []*TraceEvent_ShardMeta {
	if m != nil {
		return m.Shards
	}
	return nil
...
type TraceEvent_ShardMeta struct {
	MessageID            []byte   `protobuf:"bytes,1,opt,name=messageID" json:"messageID,omitempty"`
	XXX_NoUnkeyedLiteral struct{} `json:"-"`
	XXX_unrecognized     []byte   `json:"-"`
	XXX_sizecache        int32    `json:"-"`
...
func (m *TraceEvent_ShardMeta) Reset()         { *m = TraceEvent_ShardMeta{} }
func (m *TraceEvent_ShardMeta) String() string { return proto.CompactTextString(m) }
func (*TraceEvent_ShardMeta) ProtoMessage()    {}
func (*TraceEvent_ShardMeta) Descriptor() ([]byte, []int) {
	return fileDescriptor_0571941a1d628a80, []int{0, 16}
}
func (m *TraceEvent_ShardMeta) XXX_Unmarshal(b []byte) error {
	return m.Unmarshal(b)
}
func (m *TraceEvent_ShardMeta) XXX_Marshal(b []byte, deterministic bool) ([]byte, error) {
	if deterministic {
		return xxx_messageInfo_TraceEvent_ShardMeta.Marshal(b, m, deterministic)
	} else {
		b = b[:cap(b)]
		n, err := m.MarshalToSizedBuffer(b)
		if err != nil {
...
func (m *TraceEvent_ShardMeta) XXX_Merge(src proto.Message) {
	xxx_messageInfo_TraceEvent_ShardMeta.Merge(m, src)
}
func (m *TraceEvent_ShardMeta) XXX_Size() int {
	return m.Size()
}
func (m *TraceEvent_ShardMeta) XXX_DiscardUnknown() {
	xxx_messageInfo_TraceEvent_ShardMeta.DiscardUnknown(m)
}

var xxx_messageInfo_TraceEvent_ShardMeta proto.InternalMessageInfo

func (m *TraceEvent_ShardMeta) GetMessageID() []byte {
	if m != nil {
		return m.MessageID
	}
	return nil
...
func (*TraceEvent_ControlIDontWantMeta) Descriptor() ([]byte, []int) {
	return fileDescriptor_0571941a1d628a80, []int{0, 23}
}
...
func init() {
	proto.RegisterEnum("optimum.pb.TraceEvent_Type", TraceEvent_Type_name, TraceEvent_Type_value)
	proto.RegisterType((*TraceEvent)(nil), "optimum.pb.TraceEvent")
	proto.RegisterType((*TraceEvent_PublishMessage)(nil), "optimum.pb.TraceEvent.PublishMessage")
	proto.RegisterType((*TraceEvent_RejectMessage)(nil), "optimum.pb.TraceEvent.RejectMessage")
	proto.RegisterType((*TraceEvent_DuplicateMessage)(nil), "optimum.pb.TraceEvent.DuplicateMessage")
	proto.RegisterType((*TraceEvent_ShardContainer)(nil), "optimum.pb.TraceEvent.ShardContainer")
	proto.RegisterType((*TraceEvent_DeliverMessage)(nil), "optimum.pb.TraceEvent.DeliverMessage")
	proto.RegisterType((*TraceEvent_AddPeer)(nil), "optimum.pb.TraceEvent.AddPeer")
	proto.RegisterType((*TraceEvent_RemovePeer)(nil), "optimum.pb.TraceEvent.RemovePeer")
	proto.RegisterType((*TraceEvent_RecvRPC)(nil), "optimum.pb.TraceEvent.RecvRPC")
	proto.RegisterType((*TraceEvent_SendRPC)(nil), "optimum.pb.TraceEvent.SendRPC")
	proto.RegisterType((*TraceEvent_DropRPC)(nil), "optimum.pb.TraceEvent.DropRPC")
	proto.RegisterType((*TraceEvent_Join)(nil), "optimum.pb.TraceEvent.Join")
	proto.RegisterType((*TraceEvent_Leave)(nil), "optimum.pb.TraceEvent.Leave")
	proto.RegisterType((*TraceEvent_Graft)(nil), "optimum.pb.TraceEvent.Graft")
	proto.RegisterType((*TraceEvent_Prune)(nil), "optimum.pb.TraceEvent.Prune")
	proto.RegisterType((*TraceEvent_RPCMeta)(nil), "optimum.pb.TraceEvent.RPCMeta")
	proto.RegisterType((*TraceEvent_MessageMeta)(nil), "optimum.pb.TraceEvent.MessageMeta")
	proto.RegisterType((*TraceEvent_ShardMeta)(nil), "optimum.pb.TraceEvent.ShardMeta")
	proto.RegisterType((*TraceEvent_SubMeta)(nil), "optimum.pb.TraceEvent.SubMeta")
	proto.RegisterType((*TraceEvent_ControlMeta)(nil), "optimum.pb.TraceEvent.ControlMeta")
	proto.RegisterType((*TraceEvent_ControlIHaveMeta)(nil), "optimum.pb.TraceEvent.ControlIHaveMeta")
	proto.RegisterType((*TraceEvent_ControlIWantMeta)(nil), "optimum.pb.TraceEvent.ControlIWantMeta")
	proto.RegisterType((*TraceEvent_ControlGraftMeta)(nil), "optimum.pb.TraceEvent.ControlGraftMeta")
	proto.RegisterType((*TraceEvent_ControlPruneMeta)(nil), "optimum.pb.TraceEvent.ControlPruneMeta")
	proto.RegisterType((*TraceEvent_ControlIDontWantMeta)(nil), "optimum.pb.TraceEvent.ControlIDontWantMeta")
	proto.RegisterType((*TraceEventBatch)(nil), "optimum.pb.TraceEventBatch")
}
...
var fileDescriptor_0571941a1d628a80 = []byte{
	...
	,
}
...
func (m *TraceEvent) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	...
	if m.NewShard != nil {
		{
			size, err := m.NewShard.MarshalToSizedBuffer(dAtA[:i])
			if err != nil {
				return 0, err
			}
			i -= size
	...
	if m.UnnecessaryShard != nil {
		{
			size, err := m.UnnecessaryShard.MarshalToSizedBuffer(dAtA[:i])
			if err != nil {
				return 0, err
			}
			i -= size
	...
	if m.UnhelpfulShard != nil {
		{
			size, err := m.UnhelpfulShard.MarshalToSizedBuffer(dAtA[:i])
			if err != nil {
				return 0, err
			}
			i -= size
	...
	if m.DuplicateShard != nil {
		{
			size, err := m.DuplicateShard.MarshalToSizedBuffer(dAtA[:i])
			if err != nil {
				return 0, err
			}
			i -= size
...
func (m *TraceEvent_ShardContainer) Marshal() (dAtA []byte, err error) {
	size := m.Size()
	dAtA = make([]byte, size)
	n, err := m.MarshalToSizedBuffer(dAtA[:size])
	if err != nil {
...
func (m *TraceEvent_ShardContainer) MarshalTo(dAtA []byte) (int, error) {
	size := m.Size()
	return m.MarshalToSizedBuffer(dAtA[:size])
}

func (m *TraceEvent_ShardContainer) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	i := len(dAtA)
	_ = i
	var l int
	_ = l
	...
	if m.Coefficients != nil {
		...
		i = encodeVarintTrace(dAtA, i, uint64(len(m.Coefficients)))
		i--
		dAtA[i] = 0x1a
	}
	if m.ReceivedFrom != nil {
...
func (m *TraceEvent_RecvRPC) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	...
	if m.Length != nil {
		i = encodeVarintTrace(dAtA, i, uint64(*m.Length))
		i--
		dAtA[i] = 0x18
	}
	if m.Meta != nil {
...
func (m *TraceEvent_ShardMeta) Marshal() (dAtA []byte, err error) {
	size := m.Size()
	dAtA = make([]byte, size)
	n, err := m.MarshalToSizedBuffer(dAtA[:size])
	if err != nil {
...
func (m *TraceEvent_ShardMeta) MarshalTo(dAtA []byte) (int, error) {
	size := m.Size()
	return m.MarshalToSizedBuffer(dAtA[:size])
}

func (m *TraceEvent_ShardMeta) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	i := len(dAtA)
	_ = i
	var l int
	_ = l
...
func (m *TraceEvent) Size() (n int) {
	...
	if m.DuplicateShard != nil {
		l = m.DuplicateShard.Size()
		n += 2 + l + sovTrace(uint64(l))
	}
	if m.UnhelpfulShard != nil {
		l = m.UnhelpfulShard.Size()
		n += 2 + l + sovTrace(uint64(l))
	}
	if m.UnnecessaryShard != nil {
		l = m.UnnecessaryShard.Size()
		n += 2 + l + sovTrace(uint64(l))
	}
	if m.NewShard != nil {
		l = m.NewShard.Size()
...
func (m *TraceEvent_ShardContainer) Size() (n int) {
	if m == nil {
		return 0
	}
	var l int
...
func (m *TraceEvent_ShardMeta) Size() (n int) {
	if m == nil {
		return 0
	}
	var l int
...
func (m *TraceEvent) Unmarshal(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 17:
			if wireType != 2 {
				return fmt.Errorf("proto: wrong wireType = %d for field DuplicateShard", wireType)
			}
			var msglen int
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
			...
			if m.DuplicateShard == nil {
				m.DuplicateShard = &TraceEvent_ShardContainer{}
			}
			if err := m.DuplicateShard.Unmarshal(dAtA[iNdEx:postIndex]); err != nil {
				return err
			}
			iNdEx = postIndex
		case 18:
			if wireType != 2 {
				return fmt.Errorf("proto: wrong wireType = %d for field UnhelpfulShard", wireType)
			}
			var msglen int
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
			...
			if m.UnhelpfulShard == nil {
				m.UnhelpfulShard = &TraceEvent_ShardContainer{}
			}
			if err := m.UnhelpfulShard.Unmarshal(dAtA[iNdEx:postIndex]); err != nil {
				return err
			}
			iNdEx = postIndex
		case 19:
			if wireType != 2 {
				return fmt.Errorf("proto: wrong wireType = %d for field UnnecessaryShard", wireType)
			}
			var msglen int
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
			...
			if m.UnnecessaryShard == nil {
				m.UnnecessaryShard = &TraceEvent_ShardContainer{}
			}
			if err := m.UnnecessaryShard.Unmarshal(dAtA[iNdEx:postIndex]); err != nil {
				return err
			}
			iNdEx = postIndex
		case 20:
			if wireType != 2 {
				return fmt.Errorf("proto: wrong wireType = %d for field NewShard", wireType)
			}
			var msglen int
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
			...
			if m.NewShard == nil {
				m.NewShard = &TraceEvent_ShardContainer{}
			}
			if err := m.NewShard.Unmarshal(dAtA[iNdEx:postIndex]); err != nil {
				return err
			}
			iNdEx = postIndex
		default:
...
func (m *TraceEvent_ShardContainer) Unmarshal(dAtA []byte) error {
	l := len(dAtA)
	iNdEx := 0
	for iNdEx < l {
		preIndex := iNdEx
		...
		wireType := int(wire & 0x7)
		if wireType == 4 {
			return fmt.Errorf("proto: ShardContainer: wiretype end group for non-group")
		}
		if fieldNum <= 0 {
			return fmt.Errorf("proto: ShardContainer: illegal tag %d (wire type %d)", fieldNum, wire)
		}
		switch fieldNum {
		case 1:
			if wireType != 2 {
...
func (m *TraceEvent_RPCMeta) Unmarshal(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 2:
			...
			m.Shards = append(m.Shards, &TraceEvent_ShardMeta{})
...
func (m *TraceEvent_ShardMeta) Unmarshal(dAtA []byte) error {
	l := len(dAtA)
	iNdEx := 0
	for iNdEx < l {
		preIndex := iNdEx
